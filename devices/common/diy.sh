...
sed -i "s/DEFAULT_PACKAGES:=/DEFAULT_PACKAGES:=luci-app-firewall luci-app-opkg luci-app-filetransfer luci-app-openclash luci-app-passwall2 luci-app-ttyd luci-app-udpxy luci-app-upnp \
